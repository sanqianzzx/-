        ...
        <div class="container" style="height:100%">
            ...
            <div id="left">
                <ul class="list-unstyled">
                    ...
                    <a href="/myhistory"><li class="left_li_d">浏览历史</li></a>
                    <a href="/mymessage"><li class="left_li">站内信</li></a>
                </ul>
            </div>
            <div id="right">
                <span class="h">浏览历史 :</span>
                <button class="btn btn-primary">删除记录</button>
                <table class="table table-hover">
                    ...
                    <tr class="content">
                        <td>
                            ...
                            @if($v->harticle == $vv->harticle)
                                {{ $vv->aname }}
                            @endif
                            @endforeach
                        </td>
                        <td><a href="/article/{{$v->harticle}}">查看</a></td>
                    </tr>
                    @endforeach
                </table>
...
<script>
    ...
    $("button").click(function(){
        $.post("/remove_h",{'_token':'{{csrf_token()}}'},function(data){
