...
<div id="app">
    ...
    <div class="main" id="app">
        ...
        <div class="right">
            ...
            <form class="layui-form " action="/articleupdo" method="post">

                {{ csrf_field() }}
                <div class="layui-form-item">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-block">
                        <img class="pic_url" src="/{{ $arr[0]->pic }}" height="200px" id="purl"/>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="pic" id="pic_url" placeholder="{{ $arr[0]->pic }}" autocomplete="off" class="layui-input" disabled>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="title" value="{{ $arr[0]->aname }}" placeholder="" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width:810px;">
                        ...
                        <input type="hidden" value="{{ $arr[0]->pic }}" id="picurl" name="picurl">
                            </form>
